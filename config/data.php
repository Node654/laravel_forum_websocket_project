...
return [
    ...
    /**
     * DTO objects can be wrapped into a key like 'data' when used as a resource,
    ...
    'commands' => [
         ...
         * passed directly to the `make:data` command for generating single DTO classes, or if not set they will
         * automatically fall back to these defaults. See `php artisan make:data --help` for more information
         */
        'make' => [
            /**
             * The default namespace for generated DTO classes. This exists under the application's root namespace,
             * so the default 'DTO` will end up as '\App\DTO', and generated DTO classes will be placed in the
             * app/DTO/ folder. DTO classes can live anywhere, but this is where `make:data` will put them.
             */
            'namespace' => 'DTO',
             ...
             * to adding an alias for the DTO object. Set to a blank string (not null) to disable.
             */
            'suffix' => 'DTO',
        ],
    ],
